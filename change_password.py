        ...
        try:
            ...
            if num.isnumeric():
                ...
                if 0 < num <= row_len:
                    ...
                    with open("Data\\pw_conditions.txt", "r", encoding='utf8') as user_info:
                        lines = user_info.readlines()
                        new_text_content = ''
                        for i, line in enumerate(lines):
                            if i == num-1:        #num-1
                                new_line = "{}\t{}\t{}\t{}\t{}\t{}".format(df_user_info['사이트'][num-1],df_user_info['condition1'][num-1],df_user_info["condition2"][num-1],
                                                                df_user_info['condition3'][num-1],df_user_info["condition4"][num-1],df_user_info["condition5"][num-1])
                            else:
                                new_line = line.strip()
                            new_text_content += new_line + '\n'
                    with open("Data\\pw_conditions.txt", "w", encoding='utf8') as user_info:
                        user_info.write(new_text_content)
                    clear()
                ...
                clear()
                for i in range(row_len):
                    if num == df_user_info['사이트'][i]:
                        clear()
                        print("사이트 : {}".format(df_user_info['사이트'][i]))
                        print("<변경 전>")
                        print("PW 에 탭은 들어갈 수 없습니다.")
                        print("PW 조건(특수문자 여부 -> Y/N) : {}".format(df_user_info['condition1'][i]))
                        print("PW 조건(숫자 여부 -> Y/N) : {}".format(df_user_info['condition2'][i]))
                        print("PW 조건(대문자 여부 -> Y/N) : {}".format(df_user_info['condition3'][i]))
                        print("PW 조건(소문자 여부 -> Y/N) : {}".format(df_user_info['condition4'][i]))
                        print("PW 조건(최소자릿수-숫자) : {}\n".format(df_user_info['condition5'][i]))
                        print("PW : {}\n".format(df_user_info2['PW'][i]))
                        ...
                        while True :
                            ...
                            if(special_character == "Y" or special_character == "N"):
                                if(special_character == "Y"):
                                    df_user_info['condition1'][i] = "Y"
                                    break
                                elif special_character == "N":
                                    df_user_info['condition1'][i] = "N"
                                    break
                                else :
                                    break
                            else :
                        ...
                        while True :
                            ...
                            if(number == "Y" or number == "N"):
                                if(number == "Y"):
                                    df_user_info['condition2'][i] = "Y"
                                    break
                                elif number =="N":
                                    df_user_info['condition2'][i] = "N"
                                    break
                                else :
                                    break
                            else :
                        ...
                        while True :
                            ...
                            if(big_letter == "Y" or big_letter == "N"):
                                if(big_letter == "Y"):
                                    df_user_info['condition3'][i] = "Y"
                                    break
                                elif big_letter == "N":
                                    df_user_info['condition3'][i] = "N"
                                    break
                                else :
                                    break
                            else :
                        ...
                        while True :
                            ...
                            if(small_letter == "Y" or small_letter == "N"):
                                if(small_letter == "Y"):
                                    df_user_info['condition4'][i] = "Y"
                                    break
                                elif small_letter == "N":
                                    df_user_info['condition4'][i] = "N"
                                    break
                                else :
                                    break
                            else :
                        ...
                        while True :
                            try:
                                minimum_number = input("PW 조건(최소자릿수-숫자) : ")
                                minimum_number = int(minimum_number)
                                df_user_info['condition5'][i] = minimum_number
                                break
                            except ValueError:
                                if minimum_number == "" : # 입력받은 값이 없을 경우 ..
                                    clear()
                        ...
                        while True :
                            ...
                            # 특수문자 검사
                            if(df_user_info['condition1'][i]=="Y"):
                                if(new_pw.isalnum()):
                                    print("올바른 입력이 아닙니다. 다시 입력해주세요")
                                    sleep(2)
                                    continue
                            ...
                            # 숫자 검사
                            number_count = 0
                            if(df_user_info['condition2'][i]=="Y"):
                                for i in new_pw: 
                                    if 48<=ord(i)<=57 :
                                        number_count += 1
                                if number_count == 0 :
                            ...
                            # 대문자 검사
                            big_count = 0
                            if(df_user_info['condition3'][i]=="Y"):
                                for i in new_pw: 
                                    if 65<=ord(i)<=90 :
                                        big_count += 1
                                if big_count == 0 :
                            ...
                            # 소문자 검사
                            small_count = 0
                            if(df_user_info['condition4'][i]=="Y"):
                                for i in new_pw: 
                                    if 97<=ord(i)<=122 :
                                        small_count += 1
                                if small_count == 0 :
                            ...
                            # 최소 자릿수 검사 
                            if(len(new_pw) < df_user_info['condition5'][i]) :
                                print("올바른 입력이 아닙니다. 다시 입력해주세요.")
                                sleep(2)
                                continue
                            df_user_info2['PW'][i] = new_pw
                            break
                        ...
                        with open("Data\\"+existing_user_id+".txt", "r", encoding='utf8') as user_info:
                            ...
                            for i, line in enumerate(lines):
                                if i == i+3:        #num-1
                                    new_line = "{}\t{}\t{}".format(df_user_info2['사이트'][i],df_user_info2['ID'][i],df_user_info2["PW"][i])
                                else:
                                    new_line = line.strip()
                                new_text_content += new_line + '\n'
                        with open("Data\\"+existing_user_id+".txt", "w", encoding='utf8') as user_info:
